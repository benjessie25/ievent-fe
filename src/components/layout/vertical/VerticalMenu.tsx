...
// Type Imports
import { HomeIcon, LockIcon, UserCheck, UserIcon } from 'lucide-react'
...
import type { MenusTypes } from '@/types/menus/adminTypes'
    ...
    >
      ...
      >
        ...
        <MenuItem
            ...
            href="/user"
          > User </MenuItem>
        <MenuItem href='/account-settings' icon={<UserIcon className='w-4 h-4' />}>
              Account Settings
            </MenuItem>
        <MenuItem href='/role' icon={<UserIcon className='w-4 h-4' />}>
              Role
            </MenuItem>
        <MenuItem href='/category' icon={<UserIcon className='w-4 h-4' />}>
              Categorie
            </MenuItem>
        <MenuItem href='/add-invoice' icon={<UserIcon className='w-4 h-4' />}>
              add Invoice
            </MenuItem>
        <MenuItem href='/invoice-preview' icon={<UserIcon className='w-4 h-4' />}>
              Invoice preview
            </MenuItem>
        {/*<SubMenu*/}
        {/*  label='Dashboards'*/}
